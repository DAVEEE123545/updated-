...
.container > div {
    width: 48%; /* Each section takes up about half of the container */
}
...
form {
    ...
    padding: 20px;
    border-radius: 10px;
    box-shadow: 0px 4px 8px rgba(5, 6, 8, 1.1);
}
...
/* Style for Facility Information Header */
.info-section h2 {
    color: #2b7a78; /* Updated color */
    font-weight: bold;
    text-transform: uppercase; /* Optional for uppercase heading */
    border-bottom: 2px solid #3aafa9; /* Line under the heading */
    padding-bottom: 10px;
}

/* Add Bullets to Facility List */
.info-section ul {
